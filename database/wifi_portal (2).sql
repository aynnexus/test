...
--
-- Host: localhost:3306
-- Generation Time: Aug 29, 2017 at 01:28 AM
...
CREATE TABLE `clients` (
  ...
  `site_id` varchar(225) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `clients` (`client_id`, `user_id`, `site_id`, `status`, `created_at`, `updated_at`) VALUES
(3, 10, '["2","3"]', 1, '2017-08-28 15:21:07', '2017-08-28 15:21:07');
...
INSERT INTO `guests` (`guest_id`, `name`, `email`, `gender`, `age`, `phone`, `custom_1`, `custom_2`, `site_id`, `comment`, `status`, `type`, `social_id`, `profile_photo`, `user_ap`, `rating_key`, `rating_value`, `created_at`, `updated_at`) VALUES
(1, 'fiberno', 'fiberno@gmail.com', 1, '1', '254545452', NULL, NULL, 2, 'asfd', 1, 0, NULL, NULL, '324fdfdfd', NULL, NULL, '2017-08-27 02:13:34', '2017-08-27 07:56:20'),
(2, 'fibernbo', 'indepentdent.89@gmail.com', 1, '3', '3434343', NULL, NULL, 2, NULL, 0, 0, NULL, NULL, 'dc:9f:db:8a:21:b0', NULL, NULL, '2017-08-27 18:18:02', '2017-08-27 18:18:02'),
(3, 'fibernbo', 'indepentdent.89@gmail.com', 1, '3', '3434343', NULL, NULL, 2, NULL, 0, 0, NULL, NULL, 'dc:9f:db:8a:21:b0', NULL, NULL, '2017-08-27 18:18:44', '2017-08-27 18:18:44'),
(4, 'fibernbo', 'indepentdent.89@gmail.com', 1, '3', '3434343', NULL, NULL, 2, NULL, 0, 0, NULL, NULL, 'dc:9f:db:8a:21:b0', NULL, NULL, '2017-08-27 18:19:19', '2017-08-27 18:19:19');
...
(32, 2, 1, '2017-08-28 18:55:11', '2017-08-28 18:55:11'),
(33, 2, 2, '2017-08-28 18:55:11', '2017-08-28 18:55:11'),
(34, 2, 3, '2017-08-28 18:55:11', '2017-08-28 18:55:11');

-- --------------------------------------------------------

--
-- Table structure for table `servey_answers`
--

CREATE TABLE `servey_answers` (
...
--
-- Dumping data for table `servey_answers`
--

INSERT INTO `servey_answers` (`answer_id`, `label`, `slug`, `question_id`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'Yes i did it', 'ans_1', 1, 2, '2017-08-28 18:30:14', '2017-08-28 18:30:14'),
(2, 'Noe Iam working  fwef', 'ans_2', 1, 2, '2017-08-28 18:33:21', '2017-08-28 18:40:41');

-- --------------------------------------------------------

--
-- Table structure for table `servey_questions`
--

CREATE TABLE `servey_questions` (
  `question_id` int(11) NOT NULL,
  `label` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `created_by` int(11) NOT NULL,
...
--
-- Dumping data for table `servey_questions`
--

INSERT INTO `servey_questions` (`question_id`, `label`, `slug`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'How about the ques.', 'ques_1', 2, '2017-08-28 18:17:34', '2017-08-28 18:17:34');
...
(10, 2, 1, '2017-08-28 18:55:12', '2017-08-28 18:55:12');
...
INSERT INTO `surveys` (`survey_id`, `status`, `label`, `slug`, `created_by`, `created_at`, `updated_at`) VALUES
...
(2, 'admin', 'admin@gmail.com', '$2y$10$CJP5a2FR1lFLux2ylaL8EOIfu5NeS/KE3vt7Krc9ooYQougSjqhi6', 1, 1, 'PcQDIrtrtQ0JRPHx9vTpokFFaeCRbKuBPSfAVAOwvngJUR2GfQ7MWZO06c5W', '2017-08-26 08:17:56', '2017-08-26 08:17:56'),
...
(6, 'piza', 'piza@gmail.com', '$2y$10$La9RWk8E5n2vuMIcNnVQvOteJQM/KVLK3JCaC0fTi5vSg9WpanIsS', 2, 0, NULL, '2017-08-28 14:53:40', '2017-08-28 14:53:40'),
(7, 'new', 'new@gmail.com', '$2y$10$3OdsPTF3fxwU/VNLjqjwheHVt/MdOIi9CS9R13eYq.xRTWWGJlEuG', 2, 0, NULL, '2017-08-28 15:01:54', '2017-08-28 15:01:54'),
(10, 'YKKO', 'ykko@gmail.com', '$2y$10$HMqkBYepmJhQcAhYHK.IhuxZdOdJRy8fy8jgL2N0kalzul2BqgEmm', 2, 0, 'p0ccSBao60E3zMhaf3alAt4xiLC2bAtglgsulgtfXAfzog5YJ85GbarwsJdb', '2017-08-28 15:21:06', '2017-08-28 15:21:06');
...
--
-- Indexes for table `servey_answers`
--
ALTER TABLE `servey_answers`
  ADD PRIMARY KEY (`answer_id`);

--
-- Indexes for table `servey_questions`
--
ALTER TABLE `servey_questions`
...
--
ALTER TABLE `ratings`
  MODIFY `rating_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
--
-- AUTO_INCREMENT for table `servey_answers`
--
ALTER TABLE `servey_answers`
  MODIFY `answer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `servey_questions`
--
ALTER TABLE `servey_questions`
...
--
ALTER TABLE `surveying`
  MODIFY `surveying_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
